...
- RFC PR: [blue-forest/dropin.recipes#0000](https://github.com/blue-forest/dropin/pull/0000)
- drop'in Issue: [blue-forest/dropin#0000](https://github.com/blue-forest/dropin/issues/0000)
...
teaching it to another drop'in programmer. That generally means:

- Introducing new named concepts.
- Explaining the feature largely in terms of examples.
- Explaining how drop'in programmers should *think* about the feature, and how
  it should impact the way they use drop'in. It should explain the impact as
  concretely as possible.
- If applicable, provide sample error messages, deprecation warnings, or
  migration guidance.
- If applicable, describe the differences between teaching this to existing
  drop'in programmers and new drop'in programmers.
...
drop'in sometimes intentionally diverges from common language features.
