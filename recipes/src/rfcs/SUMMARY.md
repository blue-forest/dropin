...
drop'in.
  ...
  - Fork [this repo](https://github.com/blue-forest/dropin)
  - Copy [`./etc/rfc-template.md`](https://raw.githubusercontent.com/blue-forest/dropin/main/recipes/etc/rfc-template.md)
    to `./src/rfcs/features/0000-my-feature.md` (where "my-feature" is
...
[MIT license](https://github.com/blue-forest/dropin/blob/main/recipes/LICENSE-MIT).
